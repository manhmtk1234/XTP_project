                    ...
                    <div>
                        <div className='m-auto relative min-h-0.5 px-4 w-[55%] float-left max-930:w-full'>
                            ...
                            <p className='text-sm mb-5 font-medium'>
                                <span> 1. Quản lý hồ sơ nhân sự</span> <br />
                                <span> 2. Quản lý ca làm việc </span> <br />
                                <span> 3. Chấm công, tính lương </span> <br />
                                <span> 4. Kế hạch đào tạo, phát triển nhân sự</span> <br />
                                <span> 5. Tương tác với nhân viên </span> <br />
                            </p>
                            <div className='mt-12 mr-[-15px]'>
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        link.href = "/file/HỆ THỐNG QUẢN LÝ NHÂN SỰ TOÀN DIỆN .131224.pdf";
                                        link.download = "HỆ THỐNG QUẢN LÝ NHÂN SỰ TOÀN DIỆN .131224.pdf";
